...
class CategoriaBebidaController extends Controller
{
     /**
    ...
    public function index()
    {
        ...
        return view( 'admin.categorias_bebidas.index', [
    ...
    public function store( UpdateStoreCategoriaAlimentoRequest $request )
    {
        ...
        return to_route( 'categoria_bebidas.index' )->with( 'success', 'Categoría agregada correctamente' );
    }
    ...
    public function update(
        ...
        // dd($categoria);
        if ( $categoria->tipo_categoria !== 'bebida' ) {
    ...
    public function destroy( CategoriaAlimento $categoria )
    {
        ...
        try {
            ...
            return response()->json( [
                'message' => 'No se puede eliminar este registro porque tiene relación con algunas bebidas registrados',
            ], 422 );
        }
